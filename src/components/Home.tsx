    ...
    <>
      ...
      <section className="home" id="home">
        ...
        <p>
          ...
          applications. Experienced in Agile methodologies and Scrum practices,
          I am adept at working in iterative, collaborative environments to
          deliver high-quality solutions that align with team goals and project
          timelines. Passionate about backend development and exploring
          opportunities in Web3, I am eager to contribute to a collaborative
          team and continue growing my expertise in the tech industry.
        </p>
      </section>
    </>
  );
